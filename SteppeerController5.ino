...
double motorGear = 16; //motor gear diameter
//double angleError = 0; //degrees error needed to disengage
double microsteps = 8; //microstepping (1 = standard, 2 = half step, 4 = quarter step, 8  = eigth step)
...
void loop() {
  ...
  if (((currentTime - lastRequestTime) > 500) || ((currentTime - lastReadTime) > 500)) {
